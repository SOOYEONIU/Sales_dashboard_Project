...
product_info = {
	"date" : yesterday.strftime('%Y년 %m월 %d일'),
	"hours": 1, 
	"products": {
		...
		"남성 모노그램 로고 셔츠 - 블랙  (버버리)": {"가격": 810000, "판매량": 245}, "삼바 OG - 크림:살몬 (아디다스)": {"가격": 139000, "판매량": random.randrange(0, 1001)}
	}
}

with open ("1h.json", "w") as json_file :
